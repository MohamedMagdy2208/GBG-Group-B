...
A production-ready Streamlit chatbot that converts **natural language questions** into **PostgreSQL queries** using **LangChain + Azure OpenAI (GPT-4o)** with **24 hand-crafted few-shot examples** — including Recursive CTEs, Window Functions, and multi-table JOINs. It executes queries against the Chinook music database and returns clear, natural language answers.
...
- **Few-Shot Prompting** — 24 curated examples covering simple SELECTs, JOINs, subqueries, HAVING, Window Functions (RANK, PARTITION BY), and Recursive CTEs
...
|---|---|---|
| **Unit Tests** — SQL validation, cleaning, input checks | 32 | 32/32 ✅ |
...
| **Prompt Strategy** | Few-Shot Prompting (24 examples) |
